...
CREATE TABLE IF NOT EXISTS APPLICATION (
  idAPPLICATION INT GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS APPLICATION_has_COLOR_THEME (
  ...
  CONSTRAINT fk_APPLICATION_has_COLOR_THEME_APPLICATION1 FOREIGN KEY (APPLICATION_idAPPLICATION) REFERENCES APPLICATION (idAPPLICATION) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS APPLICATION_has_INDIVIDUAL (
  APPLICATION_idAPPLICATION INT NOT NULL,
  INDIVIDUAL_idINDIVIDUAL INT NOT NULL,
  PRIMARY KEY (APPLICATION_idAPPLICATION, INDIVIDUAL_idINDIVIDUAL),
  CONSTRAINT fk_APPLICATION_has_INDIVIDUAL_APPLICATION1 FOREIGN KEY (APPLICATION_idAPPLICATION) REFERENCES APPLICATION (idAPPLICATION) ON DELETE NO ACTION ON UPDATE NO ACTION,
